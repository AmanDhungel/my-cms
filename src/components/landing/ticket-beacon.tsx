  ...
  React.useEffect(() => {
    ...
    void (async () => {
      ...
      const coreDot = new THREE.Mesh(
        new THREE.SphereGeometry(0.3, 36, 26),
        gold,
      );
      ...
      // `Timer` replaces the deprecated `Clock`: it has to be advanced once
      // per frame, and takes the timestamp rAF already hands us.
  ...
  return (
    <div className="relative flex h-[66vh] min-h-[440px] items-center justify-center">
      ...
      <div className="text-n-400 absolute inset-x-0 bottom-1.5 text-center font-mono text-[11px] tracking-[0.06em]">
        TICKET BEACON · GEOFENCE RINGS · DRAG TO SPIN
      </div>
    </div>
  );
}
